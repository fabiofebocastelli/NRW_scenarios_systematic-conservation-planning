...
N2000 <- rast("C:/NRW_figures/NRW figures/Input_Data_figures/Habitat_directive_FFH_25832.tif")
...
tfc_feature <- rast("C:/NRW_figures/NRW figures/Input_Data_figures/total_forest_cover_25832.tif")
